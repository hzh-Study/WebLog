...
**User Request:** "Use OpenRouter to access Codex"
...
scripts/configure_provider.sh openrouter anthropic/Codex-3.5-sonnet

# 3. Execute with Codex via OpenRouter
...
# Streaming JSON events (Codex SDK style)
...
### Example 4: Accessing Codex via OpenRouter

```bash
# User: "Use openrouter to access Codex and write documentation"
