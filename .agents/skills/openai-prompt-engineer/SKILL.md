...
- **Optimize for specific models** - GPT-5, Codex-specific strategies
...
**When to use:** Working with Codex or need parsed output
...
- **Ignore model differences** - GPT-5 and Codex need different approaches
